export default class Map {
    constructor(gameStatus) {
        ...
        // Load the images:
        this.IMAGES = ['./img/UnicornRight.png', './img/UnicornLeft.png', './img/UnicornDown.png',
            './img/UnicornUp.png', './img/UnicornRight1.png', './img/UnicornLeft1.png', './img/UnicornDown1.png',
            './img/UnicornUp1.png', './img/Ghost1.png', './img/Ghost2.png', './img/NewBluePill.png',
            './img/YellowPill.png', './img/Wall.png', './img/Tunnel.png'].map((src) => {
            const IMG = new Image();
            IMG.src = src;
            return IMG;
        });
